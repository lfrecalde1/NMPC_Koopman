...
def plot_states(fig11, ax11, ax21, ax31, x, h, t, name):
    ax11.set_xlim((t[0], t[-1]))
    ax21.set_xlim((t[0], t[-1]))
    ax11.set_xticklabels([])

    state_1, = ax11.plot(t[0:x.shape[1]], h[0, 0:x.shape[1]],
                    color='#001F3F', lw=2, ls="-")
    state_1_e, = ax11.plot(t[0:x.shape[1]], x[0, 0:x.shape[1]],
                    color='#FFD700', lw=1.5, ls="--")

    state_2, = ax21.plot(t[0:x.shape[1]], h[1, 0:x.shape[1]],
                    color='#006400', lw=2, ls="-")
    state_2_e, = ax21.plot(t[0:x.shape[1]], x[1,0:x.shape[1]],
                    color='#6A5ACD', lw=1.5, ls="--")

    state_3, = ax31.plot(t[0:x.shape[1]], h[2, 0:x.shape[1]],
                    color='#8B0000', lw=2, ls="-")
    state_3_e, = ax31.plot(t[0:x.shape[1]], x[2,0:x.shape[1]],
                    color='#708090', lw=1.5, ls="--")

    ax11.set_ylabel(r"$[rad]$", rotation='vertical')
    ax11.legend([state_1, state_1_e],
            [r'$\phi$', r'$\hat{\phi}$'],
            loc="best",
...
def plot_states_velocity(fig11, ax11, ax21, ax31, x, euler_p, t, name):
    ...
    state_1, = ax11.plot(t[0:euler_p.shape[1]], euler_p[0, 0:euler_p.shape[1]],
                    color='#001F3F', lw=2, ls="-")
    state_1_e, = ax11.plot(t[0:euler_p.shape[1]], x[3, 0:euler_p.shape[1]],
                    color='#FFD700', lw=1.5, ls="--")

    state_2, = ax21.plot(t[0:euler_p.shape[1]], euler_p[1, 0:euler_p.shape[1]],
                    color='#006400', lw=2, ls="-")
    state_2_e, = ax21.plot(t[0:euler_p.shape[1]], x[4, 0:euler_p.shape[1]],
                    color='#6A5ACD', lw=1.5, ls="--")

    state_3, = ax31.plot(t[0:euler_p.shape[1]], euler_p[2, 0:euler_p.shape[1]],
                    color='#8B0000', lw=2, ls="-")
    state_3_e, = ax31.plot(t[0:euler_p.shape[1]], x[5, 0:euler_p.shape[1]],
                    color='#708090', lw=1.5, ls="--")

    ax11.set_ylabel(r"$[rad/s]$", rotation='vertical')
    ax11.legend([state_1, state_1_e],
            [r'$\dot{\phi}$', r'$\hat{\dot{\phi}}$'],
            loc="best",
            frameon=True, fancybox=True, shadow=False, ncol=2,
            borderpad=0.5, labelspacing=0.5, handlelength=3, handletextpad=0.1,
            borderaxespad=0.3, columnspacing=2)
    ...
    ax31.legend([state_3, state_3_e],
            [r'$\dot{\psi}$', r'$\hat{\dot{\psi}}$'],
            loc="best",
            frameon=True, fancybox=True, shadow=False, ncol=2,
            borderpad=0.5, labelspacing=0.5, handlelength=3, handletextpad=0.1,
            borderaxespad=0.3, columnspacing=2)
    ax31.grid(color='#949494', linestyle='-.', linewidth=0.5)
    ax31.axis([t[0], t[-1], x[5,:].min()-0.1, x[5,:].max()+0.1])
    ax31.set_xlabel(r"$\textrm{Time}[s]$", labelpad=5)
...
def plot_control(fig11, ax11, ax21, ax31, euler_p, t, name):
    ...
    ax31.legend([state_3],
            ...
            borderaxespad=0.3, columnspacing=2)
    ax31.grid(color='#949494', linestyle='-.', linewidth=0.5)
    ax31.axis([t[0], t[-1], euler_p[2,:].min()-0.1, euler_p[2,:].max()+0.1])
    ax31.set_xlabel(r"$\textrm{Time}[s]$", labelpad=5)
...
def plot_control_full(fig11, ax11, ax21, ax31, ax41, euler_p, t, name):
    ...
    state_4, = ax41.plot(t[0:euler_p.shape[1]], euler_p[3, 0:euler_p.shape[1]],
                    color='#8B0000', lw=2, ls="-")
    ...
    ax41.set_ylabel(r"$[rad/s]$", rotation='vertical')
    ax41.legend([state_4],
            [r'${\psi_c}$'],
            loc="best",
            frameon=True, fancybox=True, shadow=False, ncol=2,
    ...
    ax41.axis([t[0], t[-1], euler_p[3,:].min()-0.1, euler_p[3,:].max()+0.1])
...
def plot_states_reference(fig11, ax11, ax21, ax31, x, reference, t, name):
    ...
    state_1, = ax11.plot(t[0:x.shape[1]], reference[0, 0:x.shape[1]],
                    color='#001F3F', lw=2, ls="-")
    state_1_e, = ax11.plot(t[0:x.shape[1]], x[0, 0:x.shape[1]],
                    color='#FFD700', lw=1.5, ls="--")

    state_2, = ax21.plot(t[0:x.shape[1]], reference[1, 0:x.shape[1]],
                    color='#006400', lw=2, ls="-")
    state_2_e, = ax21.plot(t[0:x.shape[1]], x[1, 0:x.shape[1]],
                    color='#6A5ACD', lw=1.5, ls="--")

    state_3, = ax31.plot(t[0:x.shape[1]], reference[2, 0:x.shape[1]],
                    color='#8B0000', lw=2, ls="-")
    state_3_e, = ax31.plot(t[0:x.shape[1]], x[2, 0:x.shape[1]],
                    color='#708090', lw=1.5, ls="--")
